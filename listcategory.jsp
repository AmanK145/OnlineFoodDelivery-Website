...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center fixed-top topbar-transparent">
    ...
    //   <i class="bi bi-phone d-flex align-items-center"><span>+91 6204963397</span></i>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-dark">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <div class="logo me-auto">
        <h1><a href="index.html">Butterflies In Stomach</a></h1>
          ...
          <li class="dropdown"><a href="#"><span>Drop Down</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Restaurant</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="restaurant/addrestaurant">Add Restaurant</a></li>
              ...
              <li class="dropdown"><a href="#"><span>Address</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="/address/addaddress">Add Address</a></li>
              ...
              <li class="dropdown"><a href="#"><span>Category</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  ...
                  <li><a href="/category/listcategory">View Category</a></li>
                </ul>
              </li>
  ...
  <div class="container" style="margin-top: 150px;margin-bottom: 20px;padding: 20px;height: 300px;">
      ...
      <tbody>
        <%
          ...
          for(Category category: categories){
            ...
            out.println("<td><a href=\"http://localhost:5002/category/viewcategory?catId=" +category.getCatId() +"\"><button>view</button></a></td>");
            out.println("<td><a href=\"http://localhost:5002/category/delcategory?catId=" +category.getCatId() +"\"><button>Delete</button></a></td>");
            out.println("</tr>");
          }
        %>  
      </tbody>
