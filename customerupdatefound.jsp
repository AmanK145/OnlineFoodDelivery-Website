...
<body>
	...
	<div class="container">
		<form:form action="updatecustomerprocess" modelAttribute="customer" method="post">
        ...
        <form:hidden  path="customerId"  value = "${customer.customerId}"/>
            ...
            <div class="form-group">
              ...
              <form:input path="customerFirstName" class="form-control" id="customerFirstName"></form:input>
          </div>
          <div class="form-group">
