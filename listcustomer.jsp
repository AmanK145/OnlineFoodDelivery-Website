...
<body>
  ...
  <div class="container" style="margin-top: 200px;margin-bottom: 20px;padding: 20px;height: 500px;">
      ...
      <tbody>
        <%
          ...
          for(Customer customer: customers){
            out.println("<tr>");
            out.println("<td scope=\"row\">"+customer.getCustomerId()+"</td>");
            out.println("<td>"+customer.getCustomerFirstName()+" </td>");
            out.println("<td>"+customer.getCustomerLastName()+" </td>");
            out.println("<td><a href=\"http://localhost:5002/customer/viewcustomer?customerId=" +customer.getCustomerId() +"\"><button>View</button></a></td>");
            out.println("<td><a href=\"http://localhost:5002/customer/delcustomer?customerId=" +customer.getCustomerId() +"\"><button>Delete</button></a></td>");
            out.println("</tr>");
          }
        %>  
      </tbody>
