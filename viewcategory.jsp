...
<body>
            ...
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Category</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  ...
                  <li><a href="/category/fetchcategory">Update Category</a></li>
  ...
  <div class="container" style= "margin-top: 150px;margin-bottom: 20px;padding: 20px;height: 300px;">
    <form:form action="listcategory" modelAttribute="category" method="get">
      <div class="form-group">
        <label for="catId">CategoryId :</label>
                <input type="text"disabled value="${category.catId}" class="form-control" id="catId">
            </div>
       
      <div class="form-group">
        <label for="categoryName">Category Name :</label>
        <input type="text"disabled value="${category.categoryName}" class="form-control" id="categoryName">
            </div>
