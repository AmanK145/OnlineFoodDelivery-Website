...
<body>
  ...
  <!-- <div class="container" style="margin-top: 150px;margin-bottom: 20px;padding: 20px;height: 300px;"> -->
    <!-- <div class="row"> -->
  <div class="container" style="margin-top: 150px;margin-bottom: 20px;padding: 20px;height: 1200px;">
    <div class="row">
      <form:form action="/customer/addcustomer" method="post" modelAttribute="customer">
        ...
        <div class="form-group">
          ...
          <form:input path="customerFirstName" class="form-control" id="customerFirstName"/>
        </div>

        <div class="form-group">
            <label for="customerLastName">Customer Last  Name :</label>
            <form:input path="customerLastName" class="form-control" id="customerLastName"></form:input>
        </div>

        <div class="form-group">
          <label for="age">Age :</label>
          <form:input path="age" class="form-control" id="age"></form:input>
        </div>

        <div class="form-group">
           <label for="gender">Gender :</label>
           <form:input path="gender" class="form-control" id="gender"></form:input>
        </div>
        ...
        <div class="form-group">
          ...
          <form:input path="address.addressId" class="form-control" id="address"></form:input>
      </div>
      <div class="form-group">
