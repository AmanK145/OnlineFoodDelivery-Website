...
<body>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Drop Down</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="/category/addcategory"><span>Category</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
  ...
  <div class="container" style="margin-top: 150px;margin-bottom: 20px;padding: 20px;height: 300px;">
    <div class="row">
        ...
        <div class="alert alert-primary">Category saved successfully</div>
